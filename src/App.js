        ...
        <div className="flex-col">
          <div className="flex-row flex-1 bg-white p-8 rounded-lg shadow-md max-w-md my-5">
            ...
            <div>
              ...
              <br></br>
              <p>
                Enter your information below to see your average monthly carbon footprint
                (reprsented as CO<sub>2</sub>e ).
              </p>
            </div>
          </div>
              ...
              <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
                <div className="bg-white rounded-lg p-6 max-w-xl">
                  <h2 className="text-lg font-bold my-5">
                    Your average monthly carbon footprint: {carbonFootprint} kgs CO<sub>2</sub>e
                  </h2>
                  <h3 className="mb-4">
                    Relative to the average American, 
                    {carbonFootprint <= 1400 && " your carbon footprint is low. "}
                    {carbonFootprint > 1400 &&
                      carbonFootprint <= 1600 &&
                      " your carbon footprint is moderate. "}
                    {carbonFootprint > 1600 && " your carbon footprint is high. "}
                    Based on the questions we ask, an average American's carbon footprint is about 1489kgs CO<sub>2</sub>e.
                  </h3>
